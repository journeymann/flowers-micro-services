package com.flowers.microservice.monitoring.stream;
 ...
 */
public class FlowersStreamServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static final Logger logger = LoggerFactory.getLogger(FlowersStreamServlet.class);

    public FlowersStreamServlet() {
        super();
    }
