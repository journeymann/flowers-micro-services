 ...
 */
public class AbstractCustomer extends Contact{
	...
	@Valid	protected LocalDate startDate = LocalDate.now();
	@Valid	protected LocalDate endDate;
	
	public AbstractCustomer(){}
	
	public AbstractCustomer(String customerId, String firstname, String lastname, List<Address> address, List<EmailAddress> email, List<Phone> phone, List<CreditCard> cards){
	...
	public AbstractCustomer(String customerId, String firstname, String lastname, String status, List<Address> address, List<EmailAddress> email, List<Phone> phone, List<CreditCard> cards){
	...
	public AbstractCustomer(String customerId, String firstname, String lastname){
	...
	public int compareTo(AbstractCustomer that) {
